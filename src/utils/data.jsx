...
export const timeline = [
  {
    ...
    location: "Online",
    description:
      "9 Months Full Stack development course based on MERN from internshala with real time project.",
    date: "2024 - 2025",
    icon: <GraduationCap />,
  },
  {
    ...
    description:
      "Graduation in Bachelor of Computer Application(BCA) from Don Bosco college, Maram",
    date: "2020 - 2023",
    icon: <GraduationCap />,
  },
  {
    ...
    description:
      "Completed Senior Secondary in Science from Mt. Zion Senior Secondary School",
    date: "2018-2020",
    icon: <GraduationCap />,
  },
  {
